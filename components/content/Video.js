      ...
      <div className={ video.video_wrap } >
        ...
        <div className={video.video_box_wrap}>
          <div className={ video.video_box }>
            <img src={ `${prefix}/images/content/video_ive.jpg` } alt='아이브' />
            <p>[제37회 골든디스크] 디지털 음원 부문 대상 - IVE</p>
            <p>JTBC 230107</p>
          </div>
          <div className={ video.video_box }>
            <img src={`${prefix}/images/content/video_bts.jpg`} alt='방탄소년단' />
            <p>[제37회 골든디스크] 음반 부문 대상 - 방탄소년단</p>
            <p>JTBC 230107</p>
          </div>
          <div className={ video.video_box }>
            <img src={ `${prefix}/images/content/video_song_joong_gi.jpg` } alt='송중기' />
